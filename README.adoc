...
* Authenticate to aws with administrator access with aws_access_key_id and aws_secret_access_key. 

* You can refer to the steps mentioned https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html[here]

WARNING: Please note that this script does not cover the aws authentication part. You will have to do it before running the script.
