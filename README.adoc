...
* In the *config* file, you will see a profile created with the region and output format. Make a note of this profile name. It needs to be entered in a parameters file later. 
